          ...
          <div className="relative pb-12">
            ...
            <div className="max-w-sm mx-auto grid gap-12 sm:grid-cols-2 sm:max-w-3xl lg:grid-cols-4 lg:max-w-none items-start">
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">Comprehensive Consulting</h3>
                <div className="text-gray-500">Expert guidance to streamline your IT operations and achieve digital success.</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">Custom Web Development</h3>
                <div className="text-gray-500">Building user-friendly web services tailored to your business needs.</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">Innovative Solutions</h3>
                <div className="text-gray-500">Leveraging the latest technologies to drive your business forward.</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">Ongoing Support</h3>
                <div className="text-gray-500">Continuous support to ensure your digital infrastructure stays robust and up-to-date.</div>
              </div>
            </div>
          </div>
