        ...
        <div className="py-12 md:py-20">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="h2 font-cabinet-grotesk text-white mb-6" data-aos="fade-up">
              Elevate Your Business with Expert Web Development and IT Solutions
            </h2>
            <p className="text-lg text-white mb-8" data-aos="fade-up" data-aos-delay="100">
              Partner with Michigan Web Works to build robust websites and streamline your IT infrastructure. Our dedicated team ensures you stay ahead in the digital landscape with customized solutions tailored to your needs.
            </p>
