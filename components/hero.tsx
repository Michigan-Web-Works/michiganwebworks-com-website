      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-28 pb-16 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            At Michigan Web Works, we create dynamic, user-friendly web services and provide tailored IT consulting services. Our expert team is dedicated to helping you achieve your digital goals through innovative solutions and personalized support. Partner with us to elevate your online presence and streamline your IT operations.
            </p>
