...
export const metadata = {
  title: 'Schedule a Call - Michigan Web Works',
...
export default function ScheduleCall() {
  return (
    <>
      <div className="mb-10">
        <h1 className="h2 font-cabinet-grotesk">Get Customized Web Development and IT Solutions</h1>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1" htmlFor="role">
              What services are you interested in? <span className="text-pink-500">*</span>
            </label>
